...
- Latest documented Celo decision proof: decision `#57`,
...
- Latest documented proof run:
  `github-frontend-1f50d27-2026-06-14`, evidence
...
- The 2026-06-14 backend proof-readiness pass reports `npm run
