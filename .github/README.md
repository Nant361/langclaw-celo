...
- Latest documented Celo decision proof: decision `#72`,
...
- Latest documented proof run:
  `github-backend-42ba30a-2026-06-14`, evidence
...
- The 2026-06-16 backend proof-readiness pass reports `npm run
