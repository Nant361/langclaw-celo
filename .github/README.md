...
- Latest documented Celo decision proof: decision `#74`,
...
- Latest documented proof run:
  `github-backend-5a08a75-2026-06-16`, evidence
...
- The 2026-06-17 backend proof-readiness pass reports `npm run
