...
test("frontend README documents the latest proof run and ready semantics", () => {
  ...
  assert.match(
    source,
    /2026-06-1(6|7) backend proof-readiness (?:re)?check/,
    "Expected the README to document the current June 16/17 proof-readiness check."
  );
  assert.match(
    source,
