...
| Latest decision proof | Decision `#57`, signal `campaign-backend-proof`, agent `9109` |
| Latest decision proof tx | `0x14264d9fa68c19e57b5664ef2330c3169ceb33eddad3e9d5640d9c4d8b99cdb9` |
| Latest decision proof run | `github-backend-6fbfadd-2026-06-14` |
| Latest decision proof evidence | `https://github.com/Nant361/langclaw-celo/commit/6fbfadd48bf8b324aa84beeaa510d0efd6915d12` |
...
`ready`. The latest registry decision is decision `#57`,
