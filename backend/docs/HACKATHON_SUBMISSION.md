...
| Latest recorded decision | Decision `#58`, signal `campaign-backend-proof`, agent `9109`, tx `0xe0cc1aa4f3d952c09496142cb933640d2f433102681a120c8554351ac9db59b4` |
...
| On-chain agent proof | Ready | Latest registry decision `#58` is readable on Celo for agent `9109`; latest Self-linked decision remains `#1` for agent `133` |
...
5. The latest registry record is decision `#58`, `campaign-backend-proof`, for
