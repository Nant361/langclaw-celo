...
| Latest recorded decision | Decision `#74`, signal `campaign-backend-proof`, agent `9109`, tx `0x1d44f33f6713db5d03feb92e59a1ce94f41d547032b70c7c5dac09393b0c5b4e` |
...
| On-chain agent proof | Ready | Latest registry decision `#74` is readable on Celo for agent `9109`; latest Self-linked decision remains `#1` for agent `133` |
