...
| Latest recorded decision | Decision `#73`, signal `campaign-backend-proof`, agent `9109`, tx `0x11523c3a03d04332ea195ebfdeab4e2c2966fcf3a0816e5fabf62f94695edbe8` |
...
| On-chain agent proof | Ready | Latest registry decision `#73` is readable on Celo for agent `9109`; latest Self-linked decision remains `#1` for agent `133` |
