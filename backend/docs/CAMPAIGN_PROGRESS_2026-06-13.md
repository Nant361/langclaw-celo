...
| Scope | Branch | Head |
| --- | --- | --- |
| Monorepo workspace | `main` | `6a45563` |
...
| Latest ERC-8004 decision proof | Decision `#56`, signal `campaign-contracts-proof`, tx `0x2a885db5be7aa9553e0db14693ddf7e17b6898b5cc16246a62ad05f38136cae3` |
...
| Latest ERC-8004 proof run | `github-contracts-6a45563-2026-06-13` |
| Latest ERC-8004 proof evidence | `https://github.com/Nant361/langclaw-celo/commit/6a455639853fd0d5d1492af2fb076169a4057ce1` |
...
- Refreshed Celo proof references in the workspace head commits to point correctly to decision `#56`.
