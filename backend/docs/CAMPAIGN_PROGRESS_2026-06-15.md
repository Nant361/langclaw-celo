# Campaign Progress Snapshot: 2026-06-15
...
| Scope | Branch | Head |
| --- | --- | --- |
| Monorepo workspace | `main` | `7c4da9b` |
...
| Latest ERC-8004 decision proof | Decision `#60`, signal `campaign-backend-proof`, tx `0x42de71d7afe5e2500a1369b49525ae57b04f2c8ca7e7f358ddc052b63ba27677` |
...
- Refreshed Celo proof references in the workspace head commits to point correctly to decision `#60`.
