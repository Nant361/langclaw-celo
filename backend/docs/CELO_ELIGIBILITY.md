...
| Latest Celo decision proof | Decision `#57`, signal `campaign-backend-proof`, agent `9109`, tx `0x14264d9fa68c19e57b5664ef2330c3169ceb33eddad3e9d5640d9c4d8b99cdb9` |
...
registry decision `#57` for agent `9109`.
...
- `LangclawRegistry` currently exposes the documented ERC-8004 campaign proof
  for agent `9109`: decision `#57`, signal `campaign-backend-proof`, tx
