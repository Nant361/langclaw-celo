...
| Latest Celo decision proof | Decision `#73`, signal `campaign-backend-proof`, agent `9109`, tx `0x11523c3a03d04332ea195ebfdeab4e2c2966fcf3a0816e5fabf62f94695edbe8` |
...
The 2026-06-17 local eligibility and proof-readiness checks confirmed Celo
...
registry decision `#73` for agent `9109`.
...
- `LangclawRegistry` currently exposes the documented ERC-8004 campaign proof
  for agent `9109`: decision `#73`, signal `campaign-backend-proof`, tx
