...
| Latest Celo decision proof | Decision `#60`, signal `campaign-backend-proof`, agent `9109`, tx `0x42de71d7afe5e2500a1369b49525ae57b04f2c8ca7e7f358ddc052b63ba27677` |
...
registry decision `#60` for agent `9109`.
...
- `LangclawRegistry` currently exposes the documented ERC-8004 campaign proof
  for agent `9109`: decision `#60`, signal `campaign-backend-proof`, tx
