...
| Latest Celo decision proof | Decision `#74`, signal `campaign-backend-proof`, agent `9109`, tx `0x1d44f33f6713db5d03feb92e59a1ce94f41d547032b70c7c5dac09393b0c5b4e` |
...
registry decision `#74` for agent `9109`.
...
- `LangclawRegistry` currently exposes the documented ERC-8004 campaign proof
  for agent `9109`: decision `#74`, signal `campaign-backend-proof`, tx
