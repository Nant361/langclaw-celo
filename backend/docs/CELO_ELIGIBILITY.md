...
| Latest Celo decision proof | Decision `#72`, signal `campaign-backend-proof`, agent `9109`, tx `0xb52981a7282b5d48990c2d4bb69b313dbea74198f268b8a48b9cf72d56251481` |
...
The 2026-06-16 local eligibility and proof-readiness checks confirmed Celo
...
registry decision `#72` for agent `9109`.
...
- `LangclawRegistry` currently exposes the documented ERC-8004 campaign proof
  for agent `9109`: decision `#72`, signal `campaign-backend-proof`, tx
